    ...
    refSolThExp = GetConstReal( material, 'Reference Thermal Expansivity of Solid TiNbZr',GotIt)
    IF(.NOT. GotIt) THEN
    CALL Fatal('getThermalStressCoefficient', 'Reference Thermal Expansivity of Solid TiNbZr not found')
    END IF
    ...
    ! read in reference conductivity at reference temperature
    refLiqThExp = GetConstReal( material, 'Reference Thermal Expansivity of Liquid TiNbZr',GotIt)
    IF(.NOT. GotIt) THEN
    CALL Fatal('getThermalStressCoefficient', 'Reference Thermal Expansivity of Liquid TiNbZr not found')
    END IF
